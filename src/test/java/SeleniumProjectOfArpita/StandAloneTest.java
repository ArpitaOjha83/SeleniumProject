...
public class StandAloneTest {
	...
	//	driver.findElement(By.xpath("//a[@class='downtime19_close_btn ada_screen_text']")).click();
		...
		driver.findElement(By.name("login")).sendKeys("arpojha@deloitte.com");
...
//	WebElement removeProd = cartprodTitle.stream().filter(productc->
//	productc.findElement(By.xpath("//h3[@class='item-title']/a/ancestor::div//aside//i[@class='ti-close ada_screen_icon']")).getText().equals(productName)).findFirst().orElse(null);
//	removeProd.click();
//}
